...
class MCNN:
    ...
    def data_pre_train(self, kind, dataset):
        img_path = 'D:\FYP\MCNN\data/formatted_trainval/shanghaitech_part_' + dataset + '_patches_9/' + kind + '/'
        den_path = 'D:\FYP\MCNN\data/formatted_trainval/shanghaitech_part_' + dataset + '_patches_9/' + kind + '_den/'
