...
dataset = 'B'
train_path = 'D:\FYP\Project\data/formatted_trainval/shanghaitech_part_' + dataset + '_patches_9/train/'
train_den_path = 'D:\FYP\Project\data/formatted_trainval/shanghaitech_part_' + dataset + '_patches_9/train_den/'
val_path = 'D:\FYP\Project\data/formatted_trainval/shanghaitech_part_' + dataset + '_patches_9/val/'
val_den_path = 'D:\FYP\Project\data/formatted_trainval/shanghaitech_part_' + dataset + '_patches_9/val_den/'
img_path = 'D:\FYP\Project\data/original/shanghaitech/part_' + dataset + '_final/test_data/images/'
den_path = 'D:\FYP\Project\data/original/shanghaitech/part_' + dataset + '_final/test_data/ground_truth_csv/'
